...
| `src/signing-authority.ts` | `SigningAuthority` DO. owns master Ed25519, mints all certs/tokens, stores passkeys + principals + invites + bootstrap, runs the bundle-refresh alarm | `SigningAuthority` (class) |
